...
* The world coordinate of an arbitrary point <img src="https://i.imgur.com/In6aU3g.png" style="width: 100px;" /> on the body
...
* Angular Velocity
	...
	* Consider a vector r(t) at time t specified in world space, how do we represent r`(t) in terms of w(t)?
	<img src="https://i.imgur.com/lKJlRAx.png" style="width: 650px;" />
	* Given the physical meaning of R(t), what does each column change over time?
	...
	Perspective of Particles:
		...
		* each particles have a constant location <img src="https://i.imgur.com/In6aU3g.png" style="width: 100px;" /> in body space
...
* Inertia Tensor in Body Space:
	* 把initial tensor變成三個矩陣相乘
	<img src="https://i.imgur.com/0NV8EA.png" style="width: 650px;" />
