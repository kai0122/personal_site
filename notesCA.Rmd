...
* The world coordinate of an arbitrary point <img src="https://i.imgur.com/ln6aU3g.png" style="width: 20px;" /> on the body
	* R(t) represents the directions of x, y, z axes of the body space in world space at time **t**
	<img src="https://i.imgur.com/oDliQnS.png" style="width: 650px;" />
...
* Angular Velocity
	*  we describe the spin as a vector <img src="https://i.imgur.com/7VveL0c.png" style="width: 20px;" />
	...
	* Consider a vector r(t) at time t specified in world space, how do we represent r`(t) in terms of w(t)?
	<img src="https://i.imgur.com/lKJIRAx.png" style="width: 650px;" />
	* Given the physical meaning of R(t), what does each column change over time?
	<img src="https://i.imgur.com/klA8D3I.png" style="width: 650px;" />
	...
	Perspective of Particles:
		...
		* each particles have a constant location <img src="https://i.imgur.com/ln6aU3g.png" style="width: 20px;" /> in body space
...
* The mass of the i-th particle is m(i), the mass is: <img src="https://i.imgur.com/rkFneo3.png" style="width: 30px;" />
* The center of mass defined in world space is: <img src="https://i.imgur.com/LOWExDW.png" style="width: 40px;" />
* Inertia Tensor:
	* Inertia tensor describes how the mass of a rigid body is distributed relative to the center of mass
	<img src="https://i.imgur.com/ISma6D3.png" style="width: 650px;" />
