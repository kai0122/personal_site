...
<img src="https://i.imgur.com/GXc0wTW.png" width="500" />
...
* Constraints:
	* Implicit: C(x) = |x| - r = 0
	* Parametric
		<img src="https://i.imgur.com/ZvkRpIB.png" width="500" />
* Legal Acceleration
...
* Kinetic energy (動能) of the system: T = 1/2 * m * x`·x`
	* T` = 1/2 * m (x``·x`+x`·x``) = m * x`·x`` = x(f + f^) -> **f and f^ 所作的虛功**
	<img src="https://i.imgur.com/VRdOOIV.png" width="500" />
		...
		* 故只有正向力，且正向力與x垂直
* Constraint Force:
<img src="https://i.imgur.com/5fs82uT.png" width="500" />
	* If the system is at rest: v = 0
		* Only the tangent component of the applied force is kept
		<img src="https://i.imgur.com/RCp7FfD.png" width="500" />
...
* Constraints:
	...
	* Constraint Force: linear combination of constraint gradients: <img src="https://i.imgur.com/NKeASoo.png" style="width: 100px; align: left;" />	
