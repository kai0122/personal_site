...
* The world coordinate of an arbitrary point <img src="https://i.imgur.com/In6aU3g.png" style="width: 20px;" /> on the body
...
* Angular Velocity
	...
	* Consider a vector r(t) at time t specified in world space, how do we represent r`(t) in terms of w(t)?
	<img src="https://i.imgur.com/IKJIRAx.png" style="width: 650px;" />
	* Given the physical meaning of R(t), what does each column change over time?
	...
	Perspective of Particles:
		...
		* each particles have a constant location <img src="https://i.imgur.com/In6aU3g.png" style="width: 20px;" /> in body space
